pipeline {
    ...
    stages {
        ...
        stage('Notification') {
            steps {
                sh "curl -X POST -H 'Content-type: application/json' --data '{\"chat_id\": \"-1001688459445\", \"text\": \"Fernanda Ribeiro собралa приложение.\"}' https://api.telegram.org/bot5933756043:AAE8JLL5KIzgrNBeTP5e-1bkbJy4YRoeGjs/sendMessage"
            }
        }
    }
}